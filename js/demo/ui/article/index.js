...
Pager({
  data: {
    ...
    markitContet:  {
      ...
      listClass: 'card-it',
      content: `
      <p style="font-size:14px;color:#666666;font-family:" background-color:#ffffff;"=""> <strong><span style="font-size:60px;">表演时间表：</span></strong> 
      </p>
    <img src="https://dfs.8atour.com/group1/M00/08/17/CgoKq14EUgaAEqRXAAGNGNOXPCw116_880x0.jpg" alt=""> 
      <p>
        <img id="img1" src="https://dfs.8atour.com/group1/M00/08/16/CgoKql4EUjWAfTv7AATqYfvsJmY077_880x0.jpg" class="uploaded"> 
      </p>
`
    },
  }

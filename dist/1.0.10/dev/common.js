...
var _behaviors = __webpack_require__(/*! ./behaviors */ 56);

var _ui = __webpack_require__(/*! ./ui */ 66);
...
var _tree = __webpack_require__(/*! ./tree */ 57);
...
var _hooks = __webpack_require__(/*! ./hooks */ 58);
...
var _foritem = __webpack_require__(/*! ./foritem */ 6);
...
var _forlist = __webpack_require__(/*! ./forlist */ 59);
...
var md5 = exports.md5 = __webpack_require__(/*! md5 */ 60);
...
function itemReactFun(e, prefix) {
  ...
  var parentInstance = this._getAppVars();
  ...
  var _rightEvent2 = rightEvent(dsetEvt),
      fun = _rightEvent2.fun,
      param = _rightEvent2.param;
  ...
  if (data && data.length > 0) {
    data.map(function (item) {
      ...
      output.push({
        ...
        }, { title: ' ', itemClass: imgDotClass }] : { img: { src: img, itemClass: imgClass || 'mtb-20-r list-img' } },
        body: [{
  ...
  return Behavior({
    ...
    lifetimes: {
      ...
      attached: function attached() {
        //节点树完成，可以用setData渲染节点，但无法操作节点
        var properties = this.properties;
        var list = properties.list || properties.dataSource;
...
var _list = __webpack_require__(/*! ./list */ 8);
...
var _tree = __webpack_require__(/*! ./tree */ 64);
...
var _base = __webpack_require__(/*! ./base */ 65);
...
(function(){
  var crypt = __webpack_require__(/*! crypt */ 61),
      ...
      isBuffer = __webpack_require__(/*! is-buffer */ 62),
...
var _data = __webpack_require__(/*! ./data */ 86);

var _data2 = _interopRequireDefault(_data);

var _adapter = __webpack_require__(/*! ./adapter */ 85);

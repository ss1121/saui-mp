...
var data = [{
  title: 'List 图文列表',
  id: 'list',
  list: [{ title: 'Normal', attr: 'normal', littleTitle: '常规 ' }, { title: 'Wxchat', attr: 'wxchat', littleTitle: '聊天列表 ' }, { title: 'Macaohkline', attr: 'lrpic', littleTitle: '业务1 ' }, { title: 'Diytour', attr: 'tbpic', littleTitle: '业务2 ' }]
}];

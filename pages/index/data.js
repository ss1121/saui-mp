const data = [
  {
    ...
    list: [
      ...
      { title: 'Screen', attrx: 'screen', littleTitle: '筛选'},
      { title: 'Cityselection', attrx: 'selection', littleTitle: '选择城市', from: 'demo2'},
      { title: 'Car', attrx: 'car', littleTitle: '汽车品牌', from: 'demo2'},
      { title: 'Address', attrx: 'address', littleTitle: '通讯录', from: 'demo2', isNews: true},
    ]
  },
  {
    title: 'Basic 基础组件',
  ...
  },
  {
    ...
    list: [
      ...
      { title: 'slip', attrx: 'slip', littleTitle: '左滑删除 '},
    ]
  },
  {
    title: 'Feedback 操作反馈',
